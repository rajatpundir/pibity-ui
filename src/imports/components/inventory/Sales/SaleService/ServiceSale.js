...
import ServiceSalesGeneralDetails from './ServiceSalesGeneralDetails';
import ServiceSalesOrder from './ServiceSalesOrder';
import ServiceSalesInvoice from './ServiceSalesInvoice';
...
class ServiceSale extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			isOpen: false,
