...
class ProductMovementOrderReceivedList extends React.Component {
	constructor(props) {
		super();
		this.state = {
				...
				<PageWrapper mediaMargin="0" mediaWidth="100%">
					<PageBody mediaWidth="100%">
						<PageToolbar borderBottom="1px solid #e0e1e7">
							<ToolbarItems>
								<LeftItemH1>Product Movement Order Recieved</LeftItemH1>
							</ToolbarItems>
						</PageToolbar>
...
export default connect(mapStateToProps, { clearErrors, getVariables })(ProductMovementOrderReceivedList);
