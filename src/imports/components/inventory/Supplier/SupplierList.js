...
class SupplierList extends React.Component {
	...
	renderInputFields() {
		...
		list.forEach((supplier) =>{
			rows.push(
				<TableRow onClick={this.handleRowClick} key={supplier.variableName}>
					<TableData width="5%" />
					<TableData width="10%">
						<TableHeaderInner>
							<Link to={'/supplier/' + supplier.variableName}>{supplier.variableName}</Link>
						</TableHeaderInner>
					</TableData>
					<TableData width="10%">
						<TableHeaderInner>{supplier.values.contacts[0].values.name}</TableHeaderInner>
					</TableData>
					<TableData width="10%">
						<TableHeaderInner>
							<Anchor href={'tel:' + supplier.values.contacts[0].values.phone}>
								{supplier.values.contacts[0].values.phone}
							</Anchor>
						</TableHeaderInner>
					</TableData>
					<TableData width="10%">
						<TableHeaderInner>
							<Anchor href={'mailto:' + supplier.values.contacts[0].values.email} target="_blank">
								{supplier.values.contacts[0].values.email}
							</Anchor>
						</TableHeaderInner>
					</TableData>
					<TableData width="10%">
						<TableHeaderInner>
							<Anchor href={supplier.values.contacts[0].values.website} target="_blank">
								{supplier.values.contacts[0].values.website}
							</Anchor>
						</TableHeaderInner>
					</TableData>
					<TableData width="20%">
						<TableHeaderInner>
							{supplier.values.addresses[0] !== undefined ? (
								supplier.values.addresses[0].values.line1 || 'no address found'
							) : (
								'no address found'
							)}
						</TableHeaderInner>
					...
					<TableData width="10%">
						<TableHeaderInner>
							<Span>{supplier.values.general.values.status}</Span>
						</TableHeaderInner>
					</TableData>
					<TableData width="10%">
						<TableHeaderInner>
							{supplier.values.general.values.onCreditHold === false ? 'NO' : 'Yes'}
						</TableHeaderInner>
					</TableData>
				</TableRow>
			)		
