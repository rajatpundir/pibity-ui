...
import QuotesItemAccountTotal from './QuotesItemAccountTotal'
import {
	AddMoreBlock,
	AddMoreButton,
	BodyTable,
...
class QuotesItemList extends React.Component {
	constructor(props) {
		super();
		this.state = {
			list: props.list,
...
export default connect(mapStateToProps, { clearErrors, getVariables })(QuotesItemList);
